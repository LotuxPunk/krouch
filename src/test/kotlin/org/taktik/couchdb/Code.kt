...
data class Code(
        @SerialName("_id") @JsonProperty("_id") override val id: String,         // id = type|code|version  => this must be unique
        ...
        @SerialName("_attachments") @JsonProperty("_attachments") val attachments: Map<String, Attachment>? = null,
        @SerialName("_conflicts") @JsonProperty("_conflicts") val conflicts: List<String>? = null,
